package com.neilldev.quizMachine.endpoints;

import com.neilldev.quizMachine.model.QuizQuestion;
import com.neilldev.quizMachine.model.QuizQuestionAccessible;
import com.neilldev.quizMachine.model.QuizQuestionArrayAccess;
...
final public class QuizQuestionEndpoint {
    ...
    final private QuizQuestionAccessible dataAccess = new QuizQuestionArrayAccess();
    ...
    public Response getQuestions(@Context UriInfo uri,
        ...
        List<QuizQuestion> list = dataAccess.getQuestionList(start);
    ...
    /**
     * Returns the total number of quiz questions in the database.
     *
     * @param uri
    ...
    public Response getQuestion(@Context UriInfo uri,
        ...
        if (idString.trim().equalsIgnoreCase("random")) {
            QuizQuestion question = dataAccess.getRandomQuestion();
            ...
            try {
                ...
                if (identifier >= dataAccess.getQuestionListSize()) {
                    ...
                    QuizQuestion question = dataAccess.getQuestionById(identifier);
                    response = Response.ok(question)
                            .lastModified(question.getLastUpdated())
                            .location(uri.getRequestUri())
                            .build();
