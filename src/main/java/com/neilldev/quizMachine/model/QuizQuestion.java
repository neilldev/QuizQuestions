 ...
 * author neillDev
 *
 * represents the question and answers. This class is immutable and should be created by
 * the builder {@link QuizQuestionBuilder}.
 */
final public class QuizQuestion {
    ...
    public QuizQuestion(long id, String question,
    ...
    /**
     *
     * @return the date the question was last updated
     */
